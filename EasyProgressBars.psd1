#
# Module manifest for module 'EasyProgressBars'
#
...
NestedModules = @('EasyProgressBars.psm1')

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = 'New-ProgressBar', 'Get-ProgressBar', 'Write-ProgressBar', 
               'Remove-ProgressBar'
...
FileList = 'EasyProgressBars.psm1', 'Class.ProgressBar.ps1', 'ProgressBar.ps1'
